                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mb-3 text-right">
                                    <a href="{{ url('admin/produk/create') }}" class="btn btn-primary">New Produk</a>
                                </div>
                            </div>
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Produk Gambar</th>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                ...
                                                <small class="badge badge-info">
                                                    {{ baseDateFormat($item->created_at) }}, {{ $item->creator->name ?? 'System' }}
                                                </small><br>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger" id="btnDeleteproduk"
