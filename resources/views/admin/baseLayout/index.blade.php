...
<head>
    ...
    @include('admin.baseLayout.customCss')
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        @include('admin.baseLayout.navbar')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('admin.baseLayout.sidebar')

        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            <!-- Content Header (Page header) -->
            @include('admin.baseLayout.breadcrumb')
            <!-- /.content-header -->
        ...
        <!-- /.content-wrapper -->
        @include('admin.baseLayout.footer')
    ...
    @include('admin.baseLayout.customJs')
</body>
